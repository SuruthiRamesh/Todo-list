//@dart=2.9
import 'package:crudoperations/database_helper.dart';
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: FlatButton(child: Text(
                        ...
                        style: TextStyle(color: Colors.white,fontSize: 20.0),),onPressed: _submit),
                    ),
                    widget.task != null ? Container(
                      ...
                      child: FlatButton(child: Text(
                        'Delete',
                        style: TextStyle(color: Colors.white,fontSize: 20.0),),onPressed: _delete),
                    ) : SizedBox.shrink(),
                  ],
                )
                )
